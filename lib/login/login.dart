...
import 'package:picsum_photos_app/login/sign.dart';
import 'package:picsum_photos_app/product/picture_home.dart';
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const PicturePhoto()));
                      },
                      child: const Text(
                        Tiltes.login,
